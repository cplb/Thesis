...
% linespace = 1.3
\title{\hrulefill\hspace{0.2cm}\aldineright \aldineleft\hspace{0.2cm}\hrulefill \\\vspace{5mm}{\sc{}{\HUGE{}Exploring Gravity}\\\vspace{-2mm}{\LARGE{}with Gravitational Waves\\\vspace{-3mm}\& Strong-Field Tests}}\\\vspace{3mm}\hrulefill\hspace{0.2cm}\aldineright \aldineleft\hspace{0.2cm}\hrulefill}
\author{{\LARGE{}Christopher P.\ L.\ Berry}\vspace{2mm}\\Churchill College and Institute of Astronomy\\\vspace{1mm}{\Large\sc{}University of Cambridge}\vspace{1mm}}
\date{\includegraphics[width=0.26\textwidth]{../UC-shield/uc-shield-black.eps}\vspace{14mm}\\{This dissertation is submitted for the degree of}\vspace{1mm}\\{\sc\LARGE{}Doctor of Philosophy}\vspace{3mm}\\{\Large{}Supervisor: Jonathan R.\ Gair}\vspace{11mm}\\{\Large\today}}
\maketitle

...
\title{\hrulefill\hspace{0.2cm} \aldineleft \aldineright \hspcae{0.2cm}\hrulefill \newline {\sc{}{\Huge{}Exploring Gravity}\\\vspace{1mm}{\LARGE{}with Gravitational Waves\\\& Strong-Field Tests}}\newline \hrulefill\hspace{0.2cm} \aldineleft \aldineright \hspcae{0.2cm}\hrulefill}
...
\author{{\Large{}Christopher P.\ L.\ Berry}\vspace{3mm}\\Churchill College and Institute of Astronomy,\vspace{0.5mm}\\University of Cambridge\vspace{5mm}}
\date{\includegraphics[width=0.28\textwidth]{../uc-shield.eps}\vspace{11mm}\\{\sc\LARGE{}Ph.D.\ Thesis}\vspace{3mm}\\{\Large{}Supervisor: Jonathan R.\ Gair}\vspace{7mm}\\{\Large\today}}
\maketitle

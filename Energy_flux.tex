...
Following the semirelativistic approximation, the fluxes of energy and angular momentum can be derived by inserting the Schwarzschild geodesic into the flat-space radiation formulae, identified the coordinate $t$ with the flat-space time~\citep[chapter 36]{Misner1973}
\begin{align}
...
\end{equation}
Setting $n = 2$, the third term vanishes, hence the integrals $\mathscr{I}_0$ and $\mathscr{I}_1$ are sufficient to specify the series. The zeroth integral can be evaluated using \citet[3.147.6]{Gardshteyn2000} as
\begin{equation}
...
\end{equation}
where $K(k)$ is the complete elliptic integral of the first kind. The next integral can be evaluated using \citet[3.149.6]{Gardshteyn2000} as
\begin{equation}

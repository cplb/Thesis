...
We shall be interested in the asymptotic behaviour for $|\widehat{\lambda}| \rightarrow \infty$. The complex Fresnel integral has the limit
\begin{equation}
\lim_{|z|\,\rightarrow\,\infty} \mathcal{Y}(z) \sim \sgn z \exp\left(\frac{i\pi}{4}\right) + \frac{z}{\pi}\exp\left(-\frac{i\pi}{2z^2}\right).
\end{equation}
Hence,
\begin{equation}
...
\begin{equation}
\varpi_1 = \partialdiff{\omega}{\widetilde{\lambda}} = \frac{\Gamma^2}{\eta}\partialdiff{\Omega}{t}.
\end{equation}
Using these to adapt equations \ref{eq:J-1/2} and \ref{eq:jumps}, we obtain
\begin{align}
\Delta \mathcal{I}_a = {} & \eta\sum_{s\,\neq\,0}F_{a,\,s}^{(1)}(\boldsymbol{\mathcal{I}}_\star)\exp(is \widehat{\kappa}_0)\sqrt{\frac{2\pi}{|s \dot{\Omega}|}}\exp\left[\sgn(s\dot{\Omega})\frac{i\pi}{4}\right] \\

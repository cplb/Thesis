...
\begin{align}
\Delta \mathcal{I}_a = {} & \eta\sum_{s\,\neq\,0}F_{a,\,s}^{(1)}(\boldsymbol{\mathcal{I}}_\star)\exp(is \widehat{\kappa}_0)\sqrt{\frac{2\pi}{|s \langle\dot{\Omega}\rangle_t|}}\exp\left[\sgn\left(s\dot{\Omega}\right)\frac{i\pi}{4}\right] \\

...
\frac{M}{m} \Delta E = {} & -\frac{16 M^{11}}{1673196525 r\sub{p}^{6} (1 + e)^{{19}/{2}} \left\{\left(r\sub{p} - 2 M\right)\left[(1 + e)r\sub{p} - 2(1 - e)M\right]\right\}^{{5}/{2}}} \nonumber \\
 {} & \times {} \left\{\sqrt{( 1+ e)\frac{r\dub{p}}{M} - 2(3 - e)} E\left[\sqrt{\frac{4 e M}{(1+e) r\sub{p} - 2(3 - e)M}}\right] f_{1}\left(\frac{r\sub{p}}{M}, e\right) \right. \nonumber \\
...
where
\begin{align}
g_1(y, e) = {} & 169728 \left(1 - e) (1 + e)^2 \left(279297 + 219897 e^2 + 106299 e^4 + 9611 e^6 \right) \nonumber \\
...
g_2(y, e) = {} & 339456 (3 - e) (3 + e) \left(93099 - 10213 e^2 - 18155 e^4 - 10551 e^6 - 420 e^8 \right) \nonumber \\
 {} & - \left. 1536 \left(1 + e) \left(319648410 - 35712133 e^2 - 33099777 e^4 - 11272311 e^6 + 457187 e^8\right) y \right. \nonumber \\
...
\begin{align}
\frac{M}{m} \Delta E \simeq {} & -\frac{64\pi}{5} \recip{(1 + e)^{{7}/{2}}} \left(1 + \frac{73}{24} e^2 + \frac{37}{96} e^{4}\right) \left(\frac{r\sub{p}}{M}\right)^{-{7}/{2}} \nonumber \\
 {} & - \left. \frac{192\pi}{5} \recip{(1 + e)^{{9}/{2}}} \left(1 + \frac{31}{8} e^2 + \frac{65}{32} e^4 + \frac{1}{6}e^6\right) \left(\frac{r\sub{p}}{M}\right)^{-{9}/{2}} + \order\left[\left(\frac{r_{p}}{M}\right)^{-{11}/{2}}\right] \right. \\
\frac{\Delta L_{z}}{m} \simeq {} & -\frac{64\pi}{5} \recip{(1 + e)^{2}} \left(1 + \frac{7}{8} e^{2}\right) \left(\frac{r\sub{p}}{M}\right)^{-2} \nonumber \\
 {} & - \left. \frac{192 \pi}{5} \recip{(1 + e)^3} \left(1 + \frac{35}{24} e^2 + \frac{1}{4} e^4\right) \left(\frac{r\sub{p}}{M}\right)^{-3}  + \order\left[\left(\frac{r_{p}}{M}\right)^{-4}\right] \right. .
\end{align}
...
\begin{equation}
\frac{M}{m} \Delta E = -\frac{2^{7/2}} M^{{21}/{2}}}
  {{1673196525 \left(r\sub{p} - 2 M\right)^2 r\sub{p}^{{17}/{2}}}} \left[E\left(\sqrt{\frac{2 M}{r\sub{p} - 2 M}}\right) f_1\left(\frac{r\sub{p}}{M}\right) + K\left(\sqrt{\frac{2 M}{r\sub{p} - 2 M}}\right) f_2\left(\frac{r\sub{p}}{M}\right)\right]
\end{equation}
where
\begin{align}
f_1(y) = {} & - \left. 2 y \left(27850061568 - 83550184704 y + 117662445984 y^2 - 102686941680 y^3  \right.\right \nonumber \\ 
...
and
\begin{align}
f_2(y) = {} & \left. -72901570560 + 274404834816 y - 424693524096 y^2 \right. \nonumber \\ 

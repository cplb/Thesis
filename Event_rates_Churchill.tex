...
\begin{figure}[!htp]
\begin{center}
   \subfigure[{Main sequence stars}]{\includegraphics[width=0.47\textwidth]{./images/Fig_Inner_cut_1.eps}} \quad 
   \subfigure[{White dwarfs}]{\includegraphics[width=0.47\textwidth]{./images/Fig_Inner_cut_2.eps}} \\
   \subfigure[{Neutron stars}]{\includegraphics[width=0.47\textwidth]{./images/Fig_Inner_cut_3.eps}} \quad
   \subfigure[{Black holes}]{\includegraphics[width=0.47\textwidth]{./images/Fig_Inner_cut_4.eps}}

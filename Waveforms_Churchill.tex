...
\end{align}
This is correct for a slowly moving source. It is the familiar quadrupole formula \linebreak[0] (\citealt[section 36.10]{Misner1973}; \citealt[section 17.9]{Hobson2006}), derived from linearized theory, plus the next order terms. For a point mass, the energy-momentum tensor $T^{\mu\nu}$ contains a $\delta$-function which allows easy evaluation of the integrals.
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.35\textwidth]{./images/BH_SS_angles}
...
\end{center}
\end{figure}
The mission geometry for LISA/eLISA is shown in \figref{./images/SS_LISA}.
\begin{figure}
\begin{center}
 \includegraphics[width=0.27\textwidth]{./images/SS_LISA}
...
\end{enumerate}
We therefore have $d = 10$ parameters we are interested in constraining.
...
\begin{figure*}
\begin{center}
   \includegraphics[width=0.92\textwidth]{./images/Fig_MCMC_327_triangle_40}
...
\begin{figure*}
\begin{center}
   \includegraphics[width=0.92\textwidth]{./images/Fig_MCMC_53_triangle_40}
...
\begin{figure*}
\begin{center}
   \includegraphics[width=0.92\textwidth]{./images/Fig_MCMC_181_triangle_40}
...
\begin{figure*}
\begin{center}
\subfigure[MBH mass $M_\bullet$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_1}} \quad
\subfigure[MBH mass $M_\bullet$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_1}} \\
\subfigure[MBH spin $a_\ast$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_2}} \quad
\subfigure[MBH spin $a_\ast$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_2}} \\
\subfigure[Orientation angle $\Theta\sub{K}$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_8}} \quad
\subfigure[Orientation angle $\Theta\sub{K}$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_8}}
...
\begin{center}
\subfigure[Orientation angle $\Phi\sub{K}$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_9}} \quad
\subfigure[Orientation angle $\Phi\sub{K}$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_9}} \\
\subfigure[Scaled distance $\zeta$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_10}} \quad
\subfigure[Scaled distance $\zeta$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_10}} \\
\subfigure[Angular momentum $L_\infty$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_3}} \quad
\subfigure[Angular momentum $L_\infty$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_3}} \\
...
\begin{center}
\subfigure[Orbital inclination $\iota$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_4}} \quad
\subfigure[Orbital inclination $\iota$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_4}} \\
\subfigure[Periapse azimuthal phase $\phi\sub{p}$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_7}} \quad
\subfigure[Periapse azimuthal phase $\phi\sub{p}$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_7}} \\
\subfigure[Periapse polar phase $\chi\sub{p}$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_5}} \quad
\subfigure[Periapse polar phase $\chi\sub{p}$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_5}} \\
\contcaption{Distribution widths as functions of periapse $r\sub{p}$ and SNR $\rho$. Light blue is used for the standard deviation, red is the scaled $50$-percentile range and green is the scaled $95$-percentile range: all three coincide for a normal distribution. Filled circles are used for converged runs, open circles for those yet to converge. The dotted line indicates the current uncertainty for $M_\bullet$; the dashed lines the standard deviation for an uninformative prior, and the solid lines the total prior range.}
\end{center}
\end{figure*}
\begin{figure*}
...
\begin{center}
\subfigure[Periapse time $t\sub{p}$ versus periapsis.]{\includegraphics[width=0.42\textwidth]{./images/Fig_MCMC_sigmas_rp_6}} \quad
\subfigure[Periapse time $t\sub{p}$ versus SNR.]{\includegraphics[width=0.43\textwidth]{./images/Fig_MCMC_sigmas_SNR_6}} \\
...
\begin{figure*}
\begin{center}
\subfigure[MBH spin $a_\ast$.]{\includegraphics[width=0.45\textwidth]{./images/Fig_MCMC_sigmas_rp_spin_2}} \quad
\subfigure[Orientation angle $\Theta\sub{K}$.]{\includegraphics[width=0.45\textwidth]{./images/Fig_MCMC_sigmas_rp_spin_8}} \\
\subfigure[Orientation angle $\Phi\sub{K}$.]{\includegraphics[width=0.45\textwidth]{./images/Fig_MCMC_sigmas_rp_spin_9}} \quad
\subfigure[Orbital inclination $\iota$.]{\includegraphics[width=0.45\textwidth]{./images/Fig_MCMC_sigmas_rp_spin_4}} \\
\subfigure[Periapse azimuthal phase $\phi\sub{p}$]{\includegraphics[width=0.45\textwidth]{./images/Fig_MCMC_sigmas_rp_spin_7}} \quad
\subfigure[Periapse polar phase $\chi\sub{p}$.]{\includegraphics[width=0.45\textwidth]{./images/Fig_MCMC_sigmas_rp_spin_5}}
...
We have so far only been concerned with properties of bursts from our own galaxy. This is the best source for bursts because of its proximity. A natural continuation is to consider EMRBs from other MBHs. \citet{Rubbo2006} suggested that LISA should be able to detect EMRBs originating from the Virgo cluster, although the detectable rate might only be $10^{-4}\units{yr^{-1}}$ per galaxy \citep{Hopman2007}. We wish to invistage this possibility using our more accurate waveforms.
...
%\begin{minipage}{\columnwidth}
 ...
 Circinus & 1.1 & 2.82 & \citet{Graham2008,Greenhill2003} \\ & & & \citet{Karachentsev2007} \\
 NGC 4945 & 1.4 & 3.82	& \citet{Greenhill1997,Karachentsev2007} \\
 Sculptor (NGC 253) & 10 & 3.5 & \citet{Graham2011,Rodriguez-Rico2006} \\ & & & \citet{Rekola2005} \\
 NGC 4395 & 0.36 & 4.0& \citet{Peterson2005,Thim2004} \\
 NGC 3368 & 7.3 & 10.1 & \citet{Graham2011,Nowak2010} \\ & & & \citet{Tonry2001} \\
 NGC 3489 & 5.8 & 11.7 & \citet{Graham2011,Nowak2010} \\ & & & \citet{Tonry2001} \\
\hline
\end{tabular}
%\end{minipage}
\end{table*}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.43\textwidth]{./images/Fig_SNR_scaled_fit}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.43\textwidth]{./images/Fig_M_R_detect_1}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.45\textwidth]{./images/Fig_SNR_M32}
  ...
  \end{center}
\end{figure}
The fit is again done for orbits with $f_\ast = < 1 \times 10^{-3}\units{Hz}$ to avoid the bucket of the noise curve. Bursts for a $1 M_\odot$ ($10 M_\odot$) can be detected with $\rho > 10$ if the periapse is smaller than $7 r\sub{g}$ ($13 r\sub{g}$). We see that the general behaviour is the same as for the GC, but there are differences because of the position.

We can repeat the analysis for \textit{eLISA}. The scaled SNRs are shown in \figref{scaled-SNR-eLISA}.
\begin{figure}
\begin{center}
 \includegraphics[width=0.43\textwidth]{./images/Fig_SNR_scaled_fit_eLISA}
...
\begin{figure}
\begin{center}
 \includegraphics[width=0.43\textwidth]{./images/Fig_M_R_detect_2}

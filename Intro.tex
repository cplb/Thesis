...
Vector--tensor gravity introduces a vector field \citep{Will1972,Nordtvedt1972}. This is typically time-like and in Einstein--\ae{}ther theory is constrained to have unit norm \citep{Jacobson2001,Jacobson2006}. These theories have a preferred reference frame specified by the vector field. Preferred frame effects can be constrained by careful observational measurements \citep[chapter 8]{Will1993}.
...
\begin{itemize}
\item Metric-affine gravity\cite{Sotiriou2007, Sotiriou2007b}, as discussed in \secref{Action}.

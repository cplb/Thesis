...
\begin{figure}
  ...
  \includegraphics[width=0.6\textwidth]{./images/GW_spectrum}
    \caption{The spectrum of GWs. Sources (see \secref{GW-sources}) are indicated by their characteristic amplitude as measured on Earth, detectors (see \secref{GW-det}) are characterised by their sensitivity curves.}   
    \label{fig:spectrum} 
  \end{center}
\end{figure}

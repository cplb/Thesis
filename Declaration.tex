...
\end{quote}
which includes work included in chapters \ref{ch:waveforms} and \ref{ch:param} as well as \apref{window}, and
\begin{quote}
...
\end{quote}
which includes work included in \secref{k-d}, \chapref{extragal} and \apref{evolve}. Further to these, work from chapters \ref{ch:events} and \ref{ch:relax} has been published as:
\begin{quote}
...
This dissertation contains less than $6 \times 10^4$ words; evaluated using \texttt{TeXcount}, it contains $\sim 5.03 \times 10^4$ words.

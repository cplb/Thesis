...
\end{quote}
which includes work included in \secref{k-d} and \chapref{extragal}. Further to these, work from chapters \ref{ch:events} and \ref{ch:relax} has been published as:
\begin{quote}

...
\begin{figure}%[!htp]
  \centering
   \subfigure[Spectrum using no window (or, equivalently, the rectangular window). The calculated SNR is $\rho \simeq 12.5$.] {\label{fig:Windowing-Rectangular} \includegraphics[width=0.47\textwidth]{./images/Fig_h_I_9_rectangular}} \quad

...
%\fancyfoot[LO]{\today}
\fancyfoot[LO]{Christopher Berry}
\fancyfoot[RE]{Institute of Astronomy}
%\fancyfoot[RO, LE]{\thepage}
\fancyfoot[RO, LE]{Exploring Gravity}
...
\chapter*{Declaration of length}

The dissertation contains less than $6 \times 10^4$ words; evaluated using \texttt{TeXcount}, it contains $\sim 5.03 \times 10^4$ words.

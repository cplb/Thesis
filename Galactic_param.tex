...
\vspace{0.5\baselineskip}
   \includegraphics[width=0.82\textwidth]{./images/Fig_MCMC_327_triangle_40}
...
\begin{center}
\vspace{0.5\baselineskip}
   \includegraphics[width=0.82\textwidth]{./images/Fig_MCMC_53_triangle_40}
...
\begin{center}
\vspace{0.5\baselineskip}
   \includegraphics[width=0.82\textwidth]{./images/Fig_MCMC_181_triangle_40}
...
\subfigure[Scaled distance $\zeta$ versus SNR.]{\includegraphics[width=0.485\textwidth]{./images/Fig_MCMC_MW_sigmas_SNR_10}} \\
...
\subfigure[Angular momentum $L_\infty$ versus SNR.]{\includegraphics[width=0.485\textwidth]{./images/Fig_MCMC_MW_sigmas_SNR_3}} \\

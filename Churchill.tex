...
\end{quote}
in addition to unpublished material. This constitutes the greater part of my work on EMRBs; the rest is concerned with astrophysical rate estimation, which is too much to include here. My thesis has two strands: how we can use gravity to probe astrophysical systems, and how astrophysical systems can be used to explore gravitation. The study of EMRBs is former part, which shall make up the majority of the content.
\end{abstract}

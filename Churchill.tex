...
Using a Markov chain Monte Carlo algorithm to assess the accuracy we can estimate parameters, we find for periapses $r\sub{p} \lesssim 10 r\sub{g}$, EMRBs can be informative, and provide good constraints on both the MBH's mass and spin. Closer orbits provide better constraints, with the best giving accuracies of better than one part in $10^4$ for both the mass and spin parameter.

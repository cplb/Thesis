...
\end{equation}
and $S_{n}(f)$ is the noise spectral density. The inner product is derived in \apref{inner-prod}. The SNR is approximately
\begin{equation}
